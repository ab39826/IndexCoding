...
float RxDecoderC__antresult[8];

float RxDecoderC__main_dimension[8];

float **RxDecoderC__known_data;
float RxDecoderC__nulldata_result[8];
float RxDecoderC__x;
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x4085d9f0){
#line 72
  switch (arg_0x4085d9f0) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x4085d9f0);
#line 72
      break;
#line 72
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x40544598, message_t * msg, error_t error){
#line 99
  switch (arg_0x40544598) {
#line 99
    case AM_DECODED_MSG:
#line 99
...
#line 99
    default:
#line 99
      /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__default__sendDone(arg_0x40544598, msg, error);
#line 99
      break;
#line 99
    }
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x40605560, message_t * msg, error_t error){
#line 89
  switch (arg_0x40605560) {
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x40605560, msg, error);
#line 89
      break;
#line 89
    }
...
# 23 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x40604088, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x40604088) {
#line 23
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x40604088, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x40604088){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x40604088);
#line 15
      break;
#line 15
    }
...
#line 69
  if (len != sizeof(decoded_msg_t )) {
      ...
      if (__nesc_ntoh_uint16(rcm->crow.nxdata) == 255) {
          for (i = 0; i < 8 - 4 - 1; ++i) {
              for (j = 0; j < 8; ++j) {
                  RxDecoderC__known_data[i][j] = __nesc_ntoh_afloat(rcm->V_coeff[i].nxdata);
                }
            }
      ...
      success = null_vec(RxDecoderC__V_null_tr, 8, RxDecoderC__current_row + 1, RxDecoderC__S, .0001, RxDecoderC__W, RxDecoderC__rv1);
...
#line 145
      ...
      if (RxDecoderC__decode_status) {
          ...
          vectormatrixmult(RxDecoderC__S, RxDecoderC__received_data, RxDecoderC__nulldata_result, RxDecoderC__current_row + 1, 8);
          ...
          vectorantidotemult(RxDecoderC__zvresult, RxDecoderC__known_data, RxDecoderC__antresult, 8, 8 - 4 - 1, 8, RxDecoderC__ant_vec);
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x40543010, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40543010) {
#line 67
    case AM_DECODED_MSG:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x40543010, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x40608e50, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40608e50) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x40608e50, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x40604088, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x40604088, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
#line 239
  if (err == SUCCESS) {
      ...
      RxDecoderC__received_data = RxDecoderC__Make2DFloatArray(8, 8);
      RxDecoderC__known_data = RxDecoderC__Make2DFloatArray(8 - 4 - 1, 8);
      for (i = 0; i < 8; ++i) {
          for (j = 0; j < 8; ++j) {
              RxDecoderC__W[i][j] = 0;
              RxDecoderC__V[i][j] = 0;
