...
extern void *memcpy(void *arg_0x2b0a685de020, const void *arg_0x2b0a685de2f8, size_t arg_0x2b0a685de5a0);



extern void *memset(void *arg_0x2b0a685e8020, int arg_0x2b0a685e8288, size_t arg_0x2b0a685e8530);
...
typedef int (*__compar_fn_t)(const void *arg_0x2b0a68608838, const void *arg_0x2b0a68608b10);
#line 290
...
# 21 "svd.h"
int dsvd(float **a, int m, int n, float *w, float **v, double *rv1);
# 20 "RxDecoder.h"
#line 16
...
uint16_t RxDecoderC__counter = 0;
uint8_t RxDecoderC__perform_svd = 0;
float **RxDecoderC__A;
float *RxDecoderC__S2;
float **RxDecoderC__V;
double RxDecoderC__rv1[15];
#line 57
...
# 23 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x2b0a68b6c570, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x2b0a68b6c570) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x2b0a68b6c570, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x2b0a68b6c570){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x2b0a68b6c570);
#line 15
      break;
#line 15
    }
...
#line 79
  ...
  if (RxDecoderC__locked) {
      RxDecoderC__Leds__set(1);
      return;
    }
  else {
      decoded_msg_t *rcm = (decoded_msg_t *)RxDecoderC__Packet__getPayload(&RxDecoderC__packet, sizeof(decoded_msg_t ));
...
#line 86
      ...
      if (RxDecoderC__Packet__maxPayloadLength() < sizeof(decoded_msg_t )) {
          return;
        }

      __nesc_hton_uint8(rcm->counter.nxdata, RxDecoderC__counter);
      __nesc_hton_uint8(rcm->perform_svd.nxdata, RxDecoderC__perform_svd);
      if (RxDecoderC__perform_svd == 15) {


          n = 15;
          svd_return = dsvd(RxDecoderC__A, 15, 15, RxDecoderC__S2, RxDecoderC__V, RxDecoderC__rv1);
          RxDecoderC__perform_svd = 0;
          for (i = 0; i < 15; ++i) {
              __nesc_hton_afloat(rcm->A[i].nxdata, RxDecoderC__S2[i]);
            }
        }
      else {
          for (i = 0; i < 15; ++i) {
              __nesc_hton_afloat(rcm->A[i].nxdata, 0);
            }
        }
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b0a68f7bda0){
#line 72
  switch (arg_0x2b0a68f7bda0) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b0a68f7bda0);
#line 72
      break;
#line 72
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x2b0a68a2f9b0, message_t * msg, error_t error){
#line 99
  switch (arg_0x2b0a68a2f9b0) {
#line 99
    case AM_DECODED_MSG:
#line 99
...
#line 99
    default:
#line 99
      /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__default__sendDone(arg_0x2b0a68a2f9b0, msg, error);
#line 99
      break;
#line 99
    }
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x2b0a68b6d238, message_t * msg, error_t error){
#line 89
  switch (arg_0x2b0a68b6d238) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x2b0a68b6d238, msg, error);
#line 89
      break;
#line 89
    }
...
#line 119
  if (len != sizeof(decoded_msg_t )) {
      ...
      RxDecoderC__perform_svd = __nesc_ntoh_uint8(rcm->perform_svd.nxdata);
      if (RxDecoderC__perform_svd) {
          for (i = 0; i < 15; ++i) {
              RxDecoderC__A[RxDecoderC__perform_svd - 1][i] = __nesc_ntoh_afloat(rcm->A[i].nxdata);
            }
        }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x2b0a68a2cc18, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x2b0a68a2cc18) {
#line 67
    case AM_DECODED_MSG:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x2b0a68a2cc18, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x2b0a68b6e6e8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x2b0a68b6e6e8) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x2b0a68b6e6e8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x2b0a68b6c570, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x2b0a68b6c570, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
#line 145
  if (err == SUCCESS) {
      RxDecoderC__A = RxDecoderC__Make2DFloatArray(15, 15);
      RxDecoderC__V = RxDecoderC__Make2DFloatArray(15, 15);
      for (i = 0; i < 15; ++i) {
          for (j = 0; j < 15; ++j) {
              RxDecoderC__A[i][j] = 0;
            }
      ...
      RxDecoderC__S2 = (float *)malloc(15 * sizeof(float ));
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b0a68726960){
#line 64
  switch (arg_0x2b0a68726960) {
#line 64
    case SerialP__RunTx:
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2b0a68726960);
#line 64
      break;
#line 64
    }
