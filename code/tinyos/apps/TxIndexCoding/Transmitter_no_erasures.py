...
#
	...
	def cleanup(self):
		#save to text file
		logstring = '%d\t%d\t%d\t%d\t' % (self.N, self.B, self.TDMA_TRANSMISSIONS, self.TOTAL_TRANSMISSIONS)
...
if __name__ == "__main__":
	...
	m = Transmitter(N, logfile='log1.txt', itMax=20, B=4, verbose=True)
	#iterate here???
	#while (m.TDMA_MODE != -1):
		#time.sleep(.5)
