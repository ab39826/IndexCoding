...
enum CC2420ActiveMessageC____nesc_unnamed4313 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Alarm16*/AlarmOne16C__0____nesc_unnamed4314 {
...
enum /*CC2420ControlC.Spi*/CC2420SpiC__0____nesc_unnamed4315 {
...
static void RxDecoderC__RadioControl__startDone(error_t error);
#line 117
static void RxDecoderC__RadioControl__stopDone(error_t error);
...
RxDecoderC__RadioReceive__receive(
#line 60
message_t * msg, 
void * payload, 
...
static void RxDecoderC__RadioSend__sendDone(
#line 92
message_t * msg, 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 85
message_t * msg, 
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t RxDecoderC__RadioControl__start(void );
...
RxDecoderC__RadioPacket__getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
#line 95
static uint8_t RxDecoderC__RadioPacket__maxPayloadLength(void );
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void RxDecoderC__MilliTimer__startPeriodic(uint32_t dt);
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void RxDecoderC__Leds__led0Toggle(void );
#line 72
static void RxDecoderC__Leds__led1Toggle(void );
#line 89
static void RxDecoderC__Leds__led2Toggle(void );
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t RxDecoderC__RadioSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 23 "RxDecoderC.nc"
message_t RxDecoderC__ackpacket;
...
int RxDecoderC__Atable[8] = { 0, 1, 2, 3, 4, 5, 6, 7 };
int RxDecoderC__Desired_Table[8] = { 1, 0, 3, 2, 5, 4, 7, 6 };
#line 56
int RxDecoderC__ant_vec[8 - 6 - 1];


uint8_t RxDecoderC__interf_vec[6];


uint8_t RxDecoderC__interfTable0[6] = { 2, 3, 4, 5, 6, 7 };
uint8_t RxDecoderC__interfTable1[6] = { 2, 3, 4, 5, 6, 7 };
uint8_t RxDecoderC__interfTable2[6] = { 0, 1, 4, 5, 6, 7 };
uint8_t RxDecoderC__interfTable3[6] = { 0, 1, 4, 5, 6, 7 };
uint8_t RxDecoderC__interfTable4[6] = { 0, 1, 2, 3, 6, 7 };
uint8_t RxDecoderC__interfTable5[6] = { 0, 1, 2, 3, 6, 7 };
uint8_t RxDecoderC__interfTable6[6] = { 0, 1, 2, 3, 4, 5 };
uint8_t RxDecoderC__interfTable7[6] = { 0, 1, 2, 3, 4, 5 };
#line 112
float RxDecoderC__zvresult[8];
float RxDecoderC__antresult[4];

float RxDecoderC__main_dimension[8];

float **RxDecoderC__known_data;
float RxDecoderC__nulldata_result[4];
float RxDecoderC__x;
int RxDecoderC__trans = 0;
int RxDecoderC__crowMem = 1;
...
#line 164
static inline message_t *RxDecoderC__RadioReceive__receive(message_t *bufPtr, void *payload, uint8_t len);
#line 376
static inline void RxDecoderC__RadioSend__sendDone(message_t *bufPtr, error_t error);





static inline void RxDecoderC__RadioControl__startDone(error_t err);
#line 511
static inline void RxDecoderC__RadioControl__stopDone(error_t err);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
...
enum /*Counter32khz32C.Transform32*/TransformCounterC__0____nesc_unnamed4332 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform32*/TransformAlarmC__0____nesc_unnamed4333 {
...
enum HplCC2420InterruptsP____nesc_unnamed4334 {
#line 69
...
bool HplCC2420InterruptsP__ccaCheckDisabled = 0;
...
enum Atm128SpiP____nesc_unnamed4339 {
#line 241
...
enum /*Atm128SpiC.Arbiter.Queue*/FcfsResourceQueueC__1____nesc_unnamed4341 {
#line 39
...
enum /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0____nesc_unnamed4342 {
#line 69
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 56
message_t * msg, 
...
static void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 147
message_t * amsg, 
...
static error_t /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
#line 376
{
  if (&RxDecoderC__ackpacket == bufPtr) {
      RxDecoderC__locked = 0;
    }
}

# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  RxDecoderC__RadioSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40c66a48, message_t * msg, error_t error){
#line 89
  switch (arg_0x40c66a48) {
#line 89
    case 0U:
#line 89
      /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40c66a48, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40c8f490, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40c8f490, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x40c01e20, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x40c01e20, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x40c004b8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x40c004b8, msg);
#line 95
}
#line 95
...
#line 134
  ...
  __nesc_hton_int8(metadata->ack.nxdata, 0);
...
#line 45
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool Atm128SpiP__ResourceArbiter__isOwner(uint8_t arg_0x40887068){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__isOwner(arg_0x40887068);
#line 118
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x409079b8){
#line 49
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__configure(arg_0x409079b8);
#line 49
}
#line 49
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40908d38){
#line 51
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40908d38);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__immediateRequest(uint8_t arg_0x40887068){
#line 87
  unsigned char __nesc_result;
#line 87

#line 87
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__immediateRequest(arg_0x40887068);
#line 87
...
#line 79
{
  ...
  HplAtm128SpiP__SPI__setMasterBit(1);
}
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__requested(uint8_t arg_0x40908d38){
#line 43
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__requested(arg_0x40908d38);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__request(uint8_t arg_0x40887068){
#line 78
  unsigned char __nesc_result;
#line 78

#line 78
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__request(arg_0x40887068);
#line 78
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x40bcd628){
#line 92
  switch (arg_0x40bcd628) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x40bcd628);
#line 92
      break;
#line 92
    }
...
inline static void RxDecoderC__Leds__led2Toggle(void ){
#line 89
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40b299f0){
#line 72
  switch (arg_0x40b299f0) {
#line 72
    case 1U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40b299f0);
#line 72
      break;
#line 72
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x40c02490, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x40c02490, msg, payload, len);
#line 67
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t RxDecoderC__RadioSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 69
...
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void RxDecoderC__Leds__led0Toggle(void ){
#line 56
...
inline static void RxDecoderC__Leds__led1Toggle(void ){
#line 72
...
inline static uint8_t RxDecoderC__RadioPacket__maxPayloadLength(void ){
#line 95
  unsigned char __nesc_result;
#line 95
...
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * RxDecoderC__RadioPacket__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 178
      RxDecoderC__trans = __nesc_ntoh_uint16(rcm->current_transmission.nxdata);
      ...
      if (__nesc_ntoh_uint16(rcm->messageid.nxdata) == TOS_NODE_ID) {

          for (i = 0; i < 8 - 6 - 1; ++i) {
              for (j = 0; j < 4; ++j) {
                  RxDecoderC__known_data[i][j] = __nesc_ntoh_afloat(rcm->data[j].nxdata);
                }
            }

          if (!RxDecoderC__locked) {
              acm = (ack_msg_t *)RxDecoderC__RadioPacket__getPayload(&RxDecoderC__ackpacket, sizeof(ack_msg_t ));
              __nesc_hton_uint16(acm->nodeid.nxdata, TOS_NODE_ID);
              __nesc_hton_uint16(acm->current_transmission.nxdata, RxDecoderC__trans);
              __nesc_hton_uint16(acm->ack_type.nxdata, 1);

              if (RxDecoderC__RadioSend__send(AM_ACK_MSG, &RxDecoderC__ackpacket, sizeof(ack_msg_t )) == SUCCESS) {

                  RxDecoderC__locked = 1;
                  RxDecoderC__Leds__led1Toggle();
                }
            }


          for (i = 0; i < RxDecoderC__crowMem * 8; ++i) {
              for (j = 0; j < 8; ++j) {
                  RxDecoderC__V[i][j] = 0;
                  RxDecoderC__W[i][j] = 0;
                  RxDecoderC__V_null_tr[j][i] = 0;
                }
            }
      ...
      else 
        {
          ...
          if (__nesc_ntoh_uint16(rcm->messageid.nxdata) == 255) {

              if (RxDecoderC__current_row == RxDecoderC__crowMem * 8) {
                  RxDecoderC__current_row = 0;
                  for (i = 0; i < RxDecoderC__crowMem * 8; ++i) {
                      for (j = 0; j < 8; ++j) {
                          RxDecoderC__V[i][j] = 0;
              ...
              for (i = 0; i < 4; ++i) {
                  RxDecoderC__received_data[RxDecoderC__current_row][i] = __nesc_ntoh_afloat(rcm->data[i].nxdata);
                }



              RxDecoderC__main_dimension[RxDecoderC__current_row] = RxDecoderC__V[RxDecoderC__current_row][RxDecoderC__Desired_Table[TOS_NODE_ID]];
              ...
              success = null_vec(RxDecoderC__V_null_tr, RxDecoderC__crowMem * 8, RxDecoderC__current_row + 1, RxDecoderC__S, .0001, RxDecoderC__W, RxDecoderC__rv1);
...
#line 284
          ...
          if (RxDecoderC__decode_status) {
              ...
              vectormatrixmult(RxDecoderC__S, RxDecoderC__received_data, RxDecoderC__nulldata_result, RxDecoderC__current_row + 1, 4);
              ...
              vectorantidotemult(RxDecoderC__zvresult, RxDecoderC__known_data, RxDecoderC__antresult, 8, 8 - 6 - 1, 4, RxDecoderC__ant_vec);
              for (i = 0; i < 4; ++i) {
          ...
          if (!RxDecoderC__locked) {
              ...
              acm = RxDecoderC__RadioPacket__getPayload(&RxDecoderC__ackpacket, sizeof(ack_msg_t ));
              __nesc_hton_uint16(acm->nodeid.nxdata, TOS_NODE_ID);
              __nesc_hton_uint16(acm->current_transmission.nxdata, RxDecoderC__trans);

              if (acm != (void *)0 && RxDecoderC__RadioPacket__maxPayloadLength() >= sizeof(ack_msg_t )) {
                  ...
                  if (RxDecoderC__decode_status) {
                      ...
                      __nesc_hton_uint16(acm->ack_type.nxdata, 0);
                      RxDecoderC__Leds__led0Toggle();
                    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x40c04db8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40c04db8) {
#line 67
    case 6:
#line 67
      __nesc_result = RxDecoderC__RadioReceive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x40c04db8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
inline static void /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x409079b8){
#line 55
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x409079b8);
#line 55
}
#line 55
# 58 "/opt/tinyos-2.1.1/tos/system/FcfsResourceQueueC.nc"
...
#line 99
  {
    if (/*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__state == /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__RES_BUSY && /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__resId == id) {
        if (/*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Queue__isEmpty() == 0) {
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__release(uint8_t arg_0x40887068){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__release(arg_0x40887068);
#line 110
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void Atm128SpiP__Resource__granted(uint8_t arg_0x4088a398){
#line 92
  switch (arg_0x4088a398) {
#line 92
    case 0U:
#line 92
...
#line 92
    default:
#line 92
      Atm128SpiP__Resource__default__granted(arg_0x4088a398);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__granted(uint8_t arg_0x40908310){
#line 92
  Atm128SpiP__ResourceArbiter__granted(arg_0x40908310);
#line 92
}
#line 92
...
#line 387
{
  ...
  if (type == IEEE154_TYPE_ACK && CC2420TransmitP__m_msg) {
      ...
      if (CC2420TransmitP__m_state == CC2420TransmitP__S_ACK_WAIT && __nesc_ntoh_leuint8(msg_header->dsn.nxdata) == __nesc_ntoh_leuint8(ack_header->dsn.nxdata)) {
          ...
          __nesc_hton_int8(msg_metadata->ack.nxdata, 1);
...
# 71 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40826b38, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40826b38) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40826b38, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x40c004b8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x40c004b8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40826b38, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40826b38) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40826b38, data, length, error);
#line 91
      break;
#line 91
    }
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x40c004b8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x40c004b8, msg);
#line 88
}
#line 88
...
#line 89
{
  /* atomic removed: atomic calls only */
#line 90
  HplCC2420InterruptsP__ccaWaitForState = 1;
  /* atomic removed: atomic calls only */
#line 91
  HplCC2420InterruptsP__ccaCheckDisabled = 0;
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40826108){
#line 92
  switch (arg_0x40826108) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40826108);
#line 92
      break;
#line 92
    }
...
#line 105
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 106
    HplCC2420InterruptsP__ccaCheckDisabled = 1;
#line 106
    __nesc_atomic_end(__nesc_atomic); }
  return SUCCESS;
}
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x40c043f8, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40c043f8, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 117
  RxDecoderC__RadioControl__stopDone(error);
#line 117
}
#line 117
...
#line 384
  if (err == SUCCESS) {
      ...
      RxDecoderC__ant_vec[0] = RxDecoderC__Atable[TOS_NODE_ID];
      ...
      if (TOS_NODE_ID == 0) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable0[j];
            }
        }
      if (TOS_NODE_ID == 1) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable1[j];
            }
        }
      if (TOS_NODE_ID == 2) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable2[j];
            }
        }
      if (TOS_NODE_ID == 3) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable3[j];
            }
        }
      if (TOS_NODE_ID == 4) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable4[j];
            }
        }
      if (TOS_NODE_ID == 5) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable5[j];
            }
        }
      if (TOS_NODE_ID == 6) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable6[j];
            }
        }
      if (TOS_NODE_ID == 7) {
          for (j = 0; j < 6; j++) {
              RxDecoderC__interf_vec[j] = RxDecoderC__interfTable7[j];
            }
        }
#line 480
      RxDecoderC__W = RxDecoderC__Make2DFloatArray(RxDecoderC__crowMem * 8, 8);
      RxDecoderC__V = RxDecoderC__Make2DFloatArray(RxDecoderC__crowMem * 8, 8);
      RxDecoderC__V_null_tr = RxDecoderC__Make2DFloatArray(8, RxDecoderC__crowMem * 8);
      RxDecoderC__received_data = RxDecoderC__Make2DFloatArray(RxDecoderC__crowMem * 8, 4);

      RxDecoderC__known_data = RxDecoderC__Make2DFloatArray(8 - 6 - 1, 4);
      for (i = 0; i < RxDecoderC__crowMem * 8; ++i) {
          for (j = 0; j < 8; ++j) {
              RxDecoderC__W[i][j] = 0;
              RxDecoderC__V[i][j] = 0;
      ...
      for (i = 0; i < 8 - 6 - 1; ++i) {
          for (j = 0; j < 4; ++j) {
              RxDecoderC__known_data[i][j] = i / 1.0;
            }
        }
...
#line 92
  RxDecoderC__RadioControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 29
{
  return /*HplCC2420InterruptsC.InterruptFIFOPC*/Atm128GpioInterruptC__0__enable(0);
}
...
#line 52
{
  return /*HplCC2420InterruptsC.CaptureSFDC*/Atm128GpioCaptureC__0__enableCapture(1);
}
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t RxDecoderC__RadioControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 137
{
  RxDecoderC__RadioControl__start();
}
...
#line 56
{
  return /*HplCC2420InterruptsC.CaptureSFDC*/Atm128GpioCaptureC__0__enableCapture(0);
}
...
#line 302
  ...
  Atm128SpiP__Spi__enableInterrupt(0);
  /* atomic removed: atomic calls only */
  {
...
#line 108
  {
    ...
    Atm128SpiP__Spi__enableInterrupt(0);
    Atm128SpiP__Spi__setMasterDoubleSpeed(1);
    Atm128SpiP__Spi__setClockPolarity(0);
    Atm128SpiP__Spi__setClockPhase(0);
    Atm128SpiP__Spi__setClock(0);
    Atm128SpiP__Spi__enableSpi(1);
  }
  Atm128SpiP__McuPowerState__update();
}
...
#line 217
  ...
  Atm128SpiP__Spi__enableInterrupt(1);
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 227
    {
      if (tx != (void *)0) {
...
#line 47
{
  /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 100);
  return /*RxDecoderAppC.RadioSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
...
static void CC2420PacketP__PacketTimeStamp32khz__clear(message_t *msg)
{
  __nesc_hton_int8(CC2420PacketP__CC2420PacketBody__getMetadata(msg)->timesync.nxdata, 0);
