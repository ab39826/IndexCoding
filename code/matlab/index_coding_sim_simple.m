function [TOTAL_TRANSMISSIONS] = index_coding_sim_simple(K, eps_vec, verbose)
%index_coding_sim Run index coding simulation
% NOTE: This does not augment symbols to the index coding matrix,
%  i.e. symbols are not used as new side information
% Step 1: TDMA
...
%             tx_symbols(L+m_i) = Symbol(nan, nan, nan);
            tx_symbols(L+m_i) = Symbol(V(m_i,:), new_W, map);
